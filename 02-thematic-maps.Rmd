...
dens_1 <-
  ...
  geom_density_2d(data = ,
                  aes(x = lon, y = lat), colour = "red", contour_var = "count", linewidth = 0.2, n = 300, h = 100000)+
...
dens_2 <- central_orgs_islam %>% 
  ...
  ggplot()+
  geom_density_2d(data = ,
                  aes(x = lon, y = lat), colour = "steelblue3", contour_var = "count", linewidth = 0.2, n = 300, h = 100000)
